...
// UUID to numeric ID mapping - FROM DATABASE
const UUID_TO_NUMERIC: Record<string, string> = {
  "7a82d048-b478-4b4b-8b78-64eeb3a7ab86": "1", // Sony WH-1000XM5 Headphones
  "88d35c54-ce2d-40d5-92e9-4af5c7e5e330": "2", // MacBook Pro 16-inch
  "c0d069ee-031f-4340-8588-4706103e6b04": "3", // AirPods Pro 2nd Generation
  "a4e33218-57c3-4133-ac51-ca9aa711eddb": "4", // Dell Alienware 34 Curved Monitor
  "a87117d8-e9dd-49ab-a131-245cff3cbf2d": "5", // AI Translate Earphones Pro
  "ff5c7fc1-c3c7-4b35-9e21-15ba9d1c71d1": "6", // Apple Watch Ultra
  ...
  "a3f5302f-f496-4211-9737-e55de3b526c2": "9", // Dell XPS 15 Developer Edition
  "4dc6d3bf-ec23-4c1b-b47d-f156c82e92fa": "10", // iPhone 15 Pro Max
  "13e2b89d-4f65-4ad0-8c4a-5150657e5bde": "11"  // ASUS ROG Rapture GT-BE98 Gaming Router
}

// Helper function to get clean product URL using numeric IDs
const getProductUrl = (productId: string): string => {
  // Convert UUID to numeric ID for cleaner URLs
  const numericId = UUID_TO_NUMERIC[productId]
  if (numericId) {
    return `/products/${numericId}`
  }
  // Fallback to UUID if no mapping found
